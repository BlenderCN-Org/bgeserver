#!/usr/bin/env python
#/ Last Backup / 2017 / Feb / 26 / Current Projects / ThreadingServer101.py                 
#/ Transfer Copy
#########################################################################################################################
import socket####                                                                                                       #
import threading#                                                                                                       #
...
import mymodule########### Dummy Module for Testing . . . . . . . . . . . . . .                                         #
import RequestReplies##### Main Input Module All Request/Replies Are Stored Here .                                                #
...
import DirectoriesList#### for : Listing Service Directories . Stand Alone Module Only !                                #
#_______________________________________________________________________________________________________________________#
#########################################################################################################################
class SingleRecord:#________
    def __init__(self, key):#
        self.singleRecords = []#
        self.__update(key)#
    def update(self, key):#____
       self.singleRecords = key
    def showSingleRecord(self):#
        de = self.singleRecords
        codec = DecodeServer(de)#
        print ('>',codec.decode())#
    def currentshowSingleRecord(self):#
        return self.singleRecords#
    __update = update#
#_______________
class AddRecord:#__________________
...
def Requestkey(data):#______________________________Don't Forget to update key count......................
    ...
    for k in range(key):#__________________________
        if data == RequestReplies.ServerRequest(k):#___Don't Forget to update key count....
...
def RequestkeyMenu(data):#____________________
    name = RequestReplies.ServerRequest(data)#
    return name#
#
...
def Open_Mic(root_dir, file_name, file_time, recorder_lock):#
    ...
    HOST = '192.168.2.13'#_____________________________Symbolic name meaning all available interfaces
...
def Module_Directories(dir_list):# Don't Forget to Update Directory key Count. . . . . . . . . . . . . . . . . . . . . .
        dir_list = []#______________________________________________________
        key = 8# . . . . . . . .  Don't Forget to Update Directory key Count. . . . . . . . . . . . . . . . . . . . . . .
        for k in range(key):#_______________________________
            dir_list.append(DirectoryRoot.DirectoryRoot(k))#
        return dir_list#
#
            ...
            try:#_______________________________________________
                ...
                if data:#_______________________________________
                    ...
                    if dic == 21:#_______________________________________________________________________________________
                        ...
                        client.send(RequestReplies.ServerReplies(dic))# . . . . . . . . get file size. . . . . . . . . . 
                        while True:#_________________. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                            ...
                            if data:#___________________. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                ...
                                if user1 in unpack:#_____ . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                    ...
                                    client.send(RequestReplies.ServerReplies(10))# . . . get file size. . . . . . . . . .
                                    inv = Invalid()#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                    inv.set_n(1)#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                    inv()#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                    data = []
                        ...
                        dk.set_n(0)#___________________________________
                        client.send(RequestReplies.ServerReplies(dic))#
                        pcd = Identifiers.Pics_Codec()#. . . . . . . . . . 
                        pcd.set_n(1)#. . . . . . . . . . 
                        pcd()#.  . . . . . . . . . . . .
                        ...
                        RequestReplies.ServerRequest(1)#____
                        client.send(RequestReplies.ServerReplies(1))#
                        syslk = Identifiers.SystemLocks()#. . . . 
                        syslk.set_n(1)#. . . . . .
                        syslk()#. . . . . . . . .
                        ...
                        dk.set_n(0)#___________________
                        RequestReplies.ServerRequest(9)#
                        enter = Identifiers.EnterRec()#. . . . .Menu
                        enter.set_n(1)#. . . . . . .
                        enter()#. . . . . . . . . . . .
                        client.send(RequestReplies.ServerReplies(2))#____________________________________________________
                        ...
                        RequestReplies.ServerRequest(2)#______________________________________________________
                        ...
                        dk.set_n(0)#___________________
                        RequestReplies.ServerRequest(3)# . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                        while True:#___________________ . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                            addr = Identifiers.AddRec()#. . . . . . . . . Add Record
                            addr.set_n(1)#. . . . . . . . . . . . . . . . . . . . . . . . .
                            addr()#. . . . . . . . . . . . . . . . . . . . . . . . . . . .
                            client.send(RequestReplies.ServerReplies(3))#. . . . . . . . . . . . . . . . . . . . .
                            data2 = client.recv(socket_size)#. . . . . . . . . . . . . .   Add Record 
                            if data2:#_______________. . . . . . . . . . . . . . . . . . . . .   Add Record                                    
                                key = data2.decode()# . . . . . . . . . . . . . . .
                                sr = SingleRecord(key)#. . . . . . . . . . . . . . . . . . . . .
                                sr.showSingleRecord()#________________ . . . . . . . . . . . . . . .
                                client.send(RequestReplies.ServerReplies(4))#. . . . . . . . Add Record
                                adrk = Identifiers.AddRecLock()#. . . . . . . . . . . . . . . . . . . . .   Add Record 
                                adrk.set_n(1)#. . . . . .. . . . . . . . . . . . . . . . . . . . .
                                adrk()#____________________. . . . . . . . . . . . . . . . . . . . .
                                sysAddminREC = adrk.get_n()#. . . . . . . . . . . . . . . . . . . . .
                        ...
                        dk.set_n(0)#___________________
                        RequestReplies.ServerRequest(4)#.. . . . . .Lookup Rec . . . . . Lookup Rec  . . . . . 
                        ...
                        dk.set_n(0)#____________________
                        RequestReplies.ServerRequest(5)#. . . . . . . . . . . . . .. . . . . . . .Upload Records.
                        while True:#_____________________. . . . . . . . . . . . . . . . . . . .   . .Upload Records.
                            ...
                            ulr()#. . . . . . . . . . . .. . . . . . . . . . . . . . . . . . . .. . . .Upload Records.
                            client.send(RequestReplies.ServerReplies(5))#. . . . . .. . . . . . . . ..  .Upload Records.
                            ...
                            if data:#__________________. . . . . . .Upload Records.. . .. . . . . . . .Upload Records.
                                ...
                                if user1 in doubles_check:#. . . . . . . Duplicate File Checher . . . . . . . . . . . . .
                                    ...
                                    dup()#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .                                  
                                    client.send(RequestReplies.ServerReplies(24))#. . . . . . . . . . . . . . . . . . . .
                                    break#. . . . . . Duplicate File Checher . . Duplicate File Checher . . . . . . . . .
                                else:#. . . . . . . . Process Upload . . . . . . . .Process Upload . . . . . . . . . . . .
                                    client.send(RequestReplies.ServerReplies(6))#. . . . . . .Upload Records.
                                    ...
                                    if codec_buffer == (0):#. . . . . . .Upload Records.. . . . . . .Upload Records.
                                        if data3:# Standard Uploads . Text files .
                                            client.send(RequestReplies.ServerReplies(7))#. . .. . .Upload Records.
                                        ...
                                        if data3:#  . . . . . . . . . . . . . . . . . . . . . . . .
                                            ...
                                            with open(self + depack, 'wb') as f:#. . . . .. . . . . . . . . . . .Upload Records.
                                                ...
                                                break#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
##                                    elif codec_buffer == (3):#. . . . . . .Upload Records.. . . . . . .Upload Records.
##                                        if data3:# Standard Uploads . Text files .
##                                            client.send(RequestReplies.ServerReplies(7))#. . .. . .Upload Records... . .  
##                                            de = (data3.decode())#. . . . . . . . . .. . . . . . . . . . . . .Upload Records.
##                                            codec = DecodeServer(de)#.
##                                            with open('C:/Python34/CurrentProjects/' + depack, 'w') as f:#. . . . ...Upload Records.
##                                                f.write(codec.decode())#. . . . .. 
##                                                break#. . . . . . . . . . .Upload Records . 
                                    else:#____________________________________________. . . . . . .Upload Records.
                                        client.send(RequestReplies.ServerReplies(10))#. . . . . . .Upload Records.
                        ...
                        dk.set_n(0)#___________________ . . . . . . . . . . . . . . . . . . . . . . . .
                        RequestReplies.ServerRequest(6)#. . . . . . . . . > Downloads.. . . . . > Downloads. . .
                        ...
                        client.send(RequestReplies.ServerReplies(8))# . . . . > Downloads.. . . . . > Downloads. . . . . 
                        ...
                        if data:#_______________________ . . . . > Downloads.. . . . . > Downloads. . . . . . . . . . . .
                            ...
                            if file4 in file3:#________ . . . . . . . . . . . . . > Downloads.. . . . . . . . . . .. . >
                                ...
                                client.send(RequestReplies.ServerReplies(10))# . . . . . . .. . > Downloads.. . . . . >
                        ...
                        dk.set_n(0)#____________________. .. . . . . . . . . . . . . . . . .. . . .
                        RequestReplies.ServerRequest(7)#. .. . . . . . . . . . . . . . . . .. . . .
                        ...
                        RequestReplies.ServerRequest(11)#... show dir . . . . . show dir . . . . . show dir . . .
                        ...
                        while True:#____________________#. . . . . . .. . . . . . . . . . . . . . . Directory Change!
                            ...
                            if data:#__________________. . . . . . . . . . . . . . . . . . . . .
                                ...
                                file1 = ('C:/Projects/DirectoryList')# .  . . . . .Directory Change! 
                                dtyldr = DirectoryLoader2(file1)#. . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                file2 = dtyldr#. . . . . . . . . . . . . . . . . . . . .
                                lookin = packet[:12]#. . . . . . . . . . . . . . . . . . . . .
                                if lookin == ('C:/Projects/'):#   . . .  . . . . .Directory Change!                             
                                    if packet in file2:# . . . . . . . . . . . . . . . . . . . . .
                                        ...
                                        packet = precode.decode()#. . . . . . . . . . . . . . . . . . . . .       
                                        cdl = ChangeDirectory(packet)#________________. . . . . . . . . . . . . . . . . . . . .
                                        client.send(RequestReplies.ServerReplies(11))#. . . . . . .  . . . . . . . . . .
                                    else:#___________________________________________
                                        client.send(RequestReplies.ServerReplies(10))#.  . . . . .Directory Change! 
                        ...
                        dk.set_n(0)#____________________ . . . . . . . . . . . . . . . . . . . . . . . .
                        RequestReplies.ServerRequest(12)#.  . . . . . . . . . .Directory Maker.. . . . . . . . . . . . .                        mdy.set_n(1)#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                        mdy()#_______________________________________ . . . . . . . . . . . . . . . . . . . . .
                        client.send(RequestReplies.ServerReplies(12))#. . . . . . . . . . . . . . . . . . . . .
                        if sysCycle  == (1):#. . . .Directory Maker.. . . .Directory Maker.. . . . . . . . . . . . . 
                            syslk.set_n(0)#. . . . . .
                            while True:#________________. . . .Directory Maker.. . . . . . . . . . . . . . . . . . . . .
                                data = client.recv(socket_size)#___________________. . . . . . . . . . . . . . . . . . . . .
                                if data in RequestReplies.ServerRequest(13):#. . . . . . . . . . . . . . . . . . . . .
                                    client.send(RequestReplies.ServerReplies(13))#. . . . . .Directory Maker.
                                    data1 = client.recv(socket_default_size)#. . . . . . . . . . . . . . . . . . . . .
                                    if data1:#_________________. . . . . . . . . . . . . . . . . . . . .
                                        file = (data1.decode())#. . . .Directory Maker.
                                        de = file#_______________. . . . . . . . . . . . . . . . . . . . .
                                        packet = DecodeServer(de)#. . . . . . . . . . . . . . . . . . . . .
                                        depack = (packet.decode())#. . . .Directory Maker.. . . . . . . . . . . . . .. 
                                        if depack == ('#'):#______________________________ . . .. . . . . . . . . . . . .
                                            client.send(RequestReplies.ServerReplies(16))#. . . . . .Directory Maker.
                                            inv = Identifiers.Invalid()#. . . . . . . . . . . . . . . . . . . . . . . .
                                            inv.set_n(1)#. . . . . . . . . . . . .. . . . . . . . . . . . . . . . . . . 
                                            inv()#. . . . . . . . . . . .   . . . . . . . . . . . . . . . . . . . . .                                       
                                            break#. . . .Directory Maker.. . . .Directory Maker.. . . .Directory Maker.
                                        else:#___________________________________________
                                            client.send(RequestReplies.ServerReplies(14))#. . . . . .Directory Maker.
                                            root =('C:/Projects/')# . . . . . . . . . . . . . . . . . . . . . . . .
                                            makeDirect = (root + depack)# . . . . . . . . . . . . . . . . . . . . . . . .
        #                                    os.path.exists(makeDirect)#
        #                                    os.makedirs(makeDirect)#
                                            break#. . . .Directory Maker.. . . .Directory Maker.. . . .Directory Maker.
                                else:#___________________________________________
                                    client.send(RequestReplies.ServerReplies(10))#. . . . . .Directory Maker.
                                    inv = Identifiers.Invalid()#. . . . . . . . . . . . . . . . . . . . . . . . . . .
                                    inv.set_n(1)#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                    inv()#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                    break#_______________________________________________________________________________
                        else:#___________________________________________________________________________________________
                            client.send(RequestReplies.ServerReplies(10))#_______________________________________________
                    elif dic == 15:#_____________________________________________________________________________________
                        dk.set_n(0)#_____________________
                        RequestReplies.ServerRequest(15)#. . . . . > list . . . > list . . . > list.#
                        dylls = DireectoryList()#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 
                        dylls.set_n(1)# . . . . . . . . . . . . . . > list . . . > list . . . > list.  . . > list . . . 
                        dylls()# . . . . . . . . . . . . . . . > list . . . > list . . . > list.  . . > list . . . . . .
                        name = cdl.show()#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                        ...
                        dk.set_n(0)#____________________. . . . . . . . . .. . . . . . .... .. .. ... . . . . . .. . . . 
                        RequestReplies.ServerRequest(16)#. .. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                        ...
                        dk.set_n(0)#____________________ . . . . . . . . . . . . . . . . . . . . . . . .
                        RequestReplies.ServerRequest(17)# . . . . . . . . . . . . . . . . . . . . . . . .
                        mod001 = Identifiers.ModuleLoader()#. . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                        mod001.set_n(1)#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                        mod001()#____________________________________ . . . . . . . . . . . . . . . . . . . . . . . .
                        client.send(RequestReplies.ServerReplies(18))# . . . . . . . . . . . . . . . . . . . . . . . .
                        ...
                        dk.set_n(0)#____________________ . . . . . . . . . . . . . . . . . . . . . . . .
                        RequestReplies.ServerRequest(0)#. . . . . . . . . . . . . . . . . . . . . . . . .
                        client.send(RequestReplies.ServerReplies(0))#____________________________________________________
                        ...
                        RequestReplies.ServerRequest(20)#.___________ . . . . . . . . . . . . . . . . . . . . . . . .
                        client.send(RequestReplies.ServerReplies(20))#. . . . .. . socket size. 
                        ...
                        if data2:#______________  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .                                    
                            ...
                            if check_integer == True:#. . . . . . . . . . . . . . . . . . . . . . . . . .
                                ...
                                if limit >= 3 and limit <= 2048:# . . . . . . . . . . . . . . . . . . . . . . . .
                                    ...
                                    client.send(RequestReplies.ServerReplies(10))#. . . . . . . . . . . . . . . .
                                    inv = Identifiers.Invalid()#. . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                    inv.set_n(1)#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . .. . . 
                                    inv()#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                            else:#____________________________________________ . . . . . . . .
                        ...
                        dk.set_n(0)#____________________. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                        RequestReplies.ServerRequest(10)#___________. . . . . . . . . . . . . . . . . . . . . . . . . . .
                        client.send(RequestReplies.ServerReplies(23))#. . . . . . . . . . . . . . . . . . . . . . . . . .
                    elif dic == 23:# . . . . . . . . . . . . Live Mic. . . . . .. . . . Live Mic. . ..  . Live Mic. . .
                        dk.set_n(0)#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                        while True:#_______________. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                            sysCycle = syslk.get_n()#___________________. . . . . . . . . . . . . . . . . . . . . . . . . 
                            client.send(RequestReplies.ServerReplies(25))#_. . . . Live Mic. . . . . . . . . . . . . . . .
                            RequestReplies.ServerRequest(23)#. . . . . . . . . . . . . Live Mic. . . . . . . . . . . . . . .
                            data = client.recv(socket_size)#. . . . . . . . . . . . . . . . . . . . . . . . . . .
                            if data:#_______________. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                ...
                                if file_name in doubles_check:#. . . . . . . Duplicate File Checher . . . . . . . . . . . . .
                                    ...
                                    dup.set_n(0)#. . . . . . Duplicate File Checher . . . . . . . . . . . . . . . . . . .
                                    dup()#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .                                  
                                    client.send(RequestReplies.ServerReplies(31))#. . . . . . . . . . . . . . . . . . . . 
                                    break#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                else:#___________________________________________. . . . . . . . . . . . . . . . . . . . .
                                    client.send(RequestReplies.ServerReplies(27))#. . . . . . . . . . . . . . . . . . . .
                                    ...
                                    if data2:#___________________. . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                        ...
                                        if exit_func == 1:#_______________________________. . . . Live Mic. . . . . . .
                                            ...
                                            if file_time >= 3 and file_time <= 900:#. . . . Live Mic. . . . . . . . . . .
                                                ...
                                                client.send(RequestReplies.ServerReplies(26))#. . . . Live Mic. . . . . .
                                                root_dir = cdl.show()# . . . . . . . . . . . . . . . . . . . . . . . . .
                                                self = root_dir# . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                                depack = file_name# . . . . . . . .  . . . . . . . . . . . . . . . . . .
                                                if recorder_lock == 1:# . . . . . . . . . . . . . . . . . . . . . . . . .
                                                ...
                                                client.send(RequestReplies.ServerReplies(28))# . . . . . . . . . . . . . 
                                                break# . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                            else:#____________________________________________ . . . . . . . . . . . . . 
                                                client.send(RequestReplies.ServerReplies(31))#Pound . . . . .ound .
                                                inv = Identifiers.Invalid()#. . . . . . . . . . . . . . . . . . . . . . . . . . . .
                                                inv.set_n(1)#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . .. . . 
                                                inv()#. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
                        ...
                        client.send(RequestReplies.ServerReplies(29))#. . . . . . . Server*Stream . .. . Server*Stream 
                        ...
                        client.send(RequestReplies.ServerReplies(30))#Recorder OFF  . . . . . . . . . . . .Recorder OFF 
...
if __name__ == "__main__":#_______________________
    ThreadedServer('192.168.2.13', 1234).listen()#
